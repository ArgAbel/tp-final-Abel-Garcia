...
router.put('/:id',validateDto,authorize('Dveterinario:update','SuperAdmin:update'), Usuario.update);    
router.delete('/:id', validateDto,authorize('SuperAdmin:delete'), Usuario.remove);
